  ...
  <div class="main" id="components-layout-demo-basic">
    <a-layout style="height: 100%">
      ...
      <a-layout>
        ...
        <a-layout-content>
          <div class="canvas" @contextmenu.prevent="contextMenu">
...
export default {
  ...
  methods: {
    contextMenu(e) {
      ...
      this.handleCancel();
      const node = this.currentNode.target;
      if (node.aCoords && node.aCoords.tr) {
        this.posX = e.offsetX + 240;
        this.posY = e.offsetY;
        this.createLocator();
        this.visible = true;
      }
    ...
    rightMenuClick(item) {
      ...
      switch (id) {
        case 1:
          ...
          break;
        case 2:
          this.copyTarget = this.currentNode;
          break;
        case 3:
          this.parseNode();
          break;
    ...
    parseNode() {
      if (this.copyTarget) {
        const fabricObject = this.copyTarget.target;
        this.$nextTick(() => {
    ...
    createLocator() {
      ...
      locator.style.cssText = `position:absolute;left:${this.posX}px;top:${this.posY}px`
    ...
    //绘制文字对象
    drawText() {
      this.textboxObj = new fabric.Textbox(" asdasdasdsadsa", {
